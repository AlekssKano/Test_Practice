...
export const todolistsSlice = createSliceWithThunks({
  ...
  reducers: (create) => {
    ...
    return {
      ...
      fetchTodolistThunk: createAThunk(
      ...
      updateTodolistThunkTitle: createAThunk(
      ...
      removeTodolistThunk: createAThunk(
